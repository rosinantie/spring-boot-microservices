        ...
        try {
            ...
            if (jwt != null) {
                ...
                if (userJwtUtils.validateJwtToken(jwt)) {
                    String email = userJwtUtils.getEmailFromJwtToken(jwt);
                    log.info("AuthTokenFilter - JWT valid. User ID from token: {}", email);
                    ...
                    if (userDetails != null) {
                        ...
                        log.info("AuthTokenFilter - Authentication set in SecurityContext for userId: {}", email);
                    }
                } else {
